...
@section('title', 'TikTok Conversion')

@section('content')
    <h1>Convert TikTok Videos</h1>
    ...
    <form method="POST" action="{{ route('conversions.store') }}" enctype="multipart/form-data">
        ...
        <label for="url">Or Enter TikTok Video URL:</label>
        <input type="text" name="url" id="url" placeholder="https://tiktok.com/video">
